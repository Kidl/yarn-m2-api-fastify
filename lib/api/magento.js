...
async function getAttributes() {
  const uri = '/rest/V1/products/attributes?searchCriteria[filter_groups][0][filters][0][field]=attribute_code'
    + '&searchCriteria[filter_groups][0][filters][0][value]=brand,gauge,gauge_stockinette,fiber_content,fabric_care,'
    + 'color_tint,certificates,needle_length,thickness,color,material'
...
async function getConfigurableProductBySku(sku) {
  ...
  try {
    ...
    console.log('Cannot get Configurable child');
